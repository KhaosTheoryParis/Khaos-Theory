...
import { createAdminSalesAnalyticsGetHandler } from "../../../../services/admin-sales-analytics";
...
const getAdminSalesAnalytics = createAdminSalesAnalyticsGetHandler({
...
export function GET(request: Request) {
  return getAdminSalesAnalytics(request);
}
